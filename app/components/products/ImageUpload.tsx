...
export default function ImageUpload({image} : {image: string | undefined}) {
    ...
    return ( 
        <CldUploadWidget
            ...
            options={{
                maxFiles: 1  // subir una imagen por producto 
            }}>
            {({open}) => (
                <>
                ...
                <input  // este input es para enviar la url de la imagen al backend, ya que el widget de cloudinary no lo hace automáticamente
                   type="hidden"
                   name="image"
